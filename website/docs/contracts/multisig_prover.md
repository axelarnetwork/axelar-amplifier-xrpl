...
11. The Verifiers see the `PollStarted` event and look up the `SignersRotated` event on the External Gateway and
    verify the event matches the verifier set in the poll.
